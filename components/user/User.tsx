...
const s = StyleSheet.create({
    ...
    // TOP BAR
    topBar: { width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20, paddingTop: 80 },
    headerTitle: { fontSize: 20, fontWeight: 'bold', color: '#fff', letterSpacing: 2 },
    topBarActions: { flexDirection: 'row', gap: 8 },
    profileBtn: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(247,177,118,0.12)', borderWidth: 1.5, borderColor: 'rgba(247,177,118,0.4)', alignItems: 'center', justifyContent: 'center' },
    logoutBtn: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(255,107,107,0.1)', borderWidth: 1.5, borderColor: 'rgba(255,107,107,0.35)', alignItems: 'center', justifyContent: 'center' },

    // TARJETAS DE NAVEGACIÓN
    navCards: { width: '100%', gap: 10, marginBottom: 14 },
    navCard: { flexDirection: 'row', alignItems: 'center', padding: 14, backgroundColor: 'rgba(255,255,255,0.06)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', borderRadius: 14 },
    navCardIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(247,177,118,0.15)', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    navCardInfo: { flex: 1 },
    navCardTitle: { color: '#fff', fontSize: 16, fontWeight: '700' },
    navCardSub: { color: 'rgba(255,255,255,0.5)', fontSize: 12, marginTop: 2 },
    ...
    calDay: { width: '14.28%', paddingVertical: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 8, height: 65 },
    calDayEmpty: {},
    calDayToday: { backgroundColor: 'rgba(255,255,255,0.1)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.25)' },
    calDayReserved: { backgroundColor: 'rgba(247,177,118,0.2)', borderWidth: 1, borderColor: 'rgba(247,177,118,0.45)' },
    calDayTodayReserved: { backgroundColor: 'rgba(247,177,118,0.3)', borderColor: '#F7B176' },
    calDayText: { fontSize: 13, color: 'rgba(255,255,255,0.6)' },
    calDayTextToday: { color: '#fff', fontWeight: '700' },
    calDayTextReserved: { color: '#F7B176', fontWeight: '700' },
